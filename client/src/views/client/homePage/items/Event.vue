                ...
                <div class="col-lg-8 col-md-12">
                  <div class="single-news mb-lg-0 mb-4">
                    ...
                    <div class="news-data d-flex justify-content-between">
                      <routerLink :to="`/${$i18n.locale}/posts/events/` + post_data.category" class="deep-orange-text">
                    ...
                    <div class="row">
                      <div class="view overlay rounded z-depth-1 mb-4 col-lg-2 col-md-12" v-for="(i,index) in post_data.img" :key="index">
                        <img class="img-fluid" :src="$store.state.server_ip + '/api/containers/post/download/' + i" alt="Sample image">
                        <a>
                        ...
                        <div class="row">
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-map-marker"></i> {{post_data.events.place}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-calendar-check"></i> {{post_data.events.start_date}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-calendar-times"></i> {{post_data.events.end_date}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
