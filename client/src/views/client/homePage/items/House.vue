                ...
                <div class="col-lg-8 col-md-12">
                  <div class="single-news mb-lg-0 mb-4">
                    ...
                    <div class="news-data d-flex justify-content-between">
                      <routerLink :to="`/${$i18n.locale}/posts/houses/` + post_data.category" class="deep-orange-text">
                      ...
                      <div class="view overlay rounded z-depth-1 mb-4 col-lg-2 col-md-12" v-for="(i,index) in post_data.img" :key="i +1">
                        ...
                        <div class="row">
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-bed"></i> {{post_data.houses.bedroom}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-bow"></i> {{post_data.houses.bathroom}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-fingerprint"></i> {{post_data.houses.kitchin}}</span></h4>
                          </div>
                           <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            <h4><span class="badge badge-primary"><i class="fa fa-calendar"></i> {{post_data.houses.square_footage}}</span></h4>
                          </div>
                          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div class="form-group" v-if="$store.getters.isLoggedIn && JSON.parse(this.$store.state.account).id != post_data.account_id">
