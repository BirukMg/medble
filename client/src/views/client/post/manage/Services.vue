      ...
      <div class="container">
        <section>
          <div>
            ...
            <div class="row">
            <div class="col-6">
              <h6 style="float: left" class="font-weight-bold">{{$t('post.category')}}: <span class="text-secondary font-weight-bold text-capitalize">{{$t('category.services.' + 'services'.toUpperCase())}} ({{$t('category.services.' + postData.category.toLowerCase())}})</span></h6>
              ...
              <div class="form-group">
                ...
                <select id="category" class="browser-default custom-select custom-select-sm" v-model="postData.category">
                  <option v-for="(i,index) in services" :key="i" :value="services[index]">{{$t('category.services.' + i.toLowerCase())}}</option>
                </select>
              </div>
              <div class="form-group">
