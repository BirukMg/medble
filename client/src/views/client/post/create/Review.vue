    ...
    <div>
      ...
      <div class="container">
       <v-snackbar v-model="snackbar.snackbar" :top="true" style="margin-top: 70px" :color="snackbar.color">
        ...
        <div class="col-2"></div>
        <div class="col-8">
          <h6 style="float: left">{{$t('post.category')}}: <span class="text-secondary font-weight-bold">{{$t('category.reviews.' + 'reviews'.toUpperCase())}} ({{$t('category.reviews.' + item.toLowerCase())}})</span></h6>
