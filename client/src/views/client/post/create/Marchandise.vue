      ...
      <div class="container">
        <section>
          <div>
            ...
            <div class="row">
            <div class="col-6">
              <h6 style="float: left">{{$t('post.category')}}: <span class="text-secondary font-weight-bold">{{$t('category.marchandise.' + 'marchandise'.toUpperCase())}} ({{$t('category.marchandise.' + item.toLowerCase())}})</span></h6>
